 ...
 * Builder, which is free for non-commercial
 * use. If Jigloo is being used commercially (ie, by a corporation, company or
 * business for any purpose whatever) then
 * you should purchase a license for each developer using Jigloo. Please visit
 * www.cloudgarden.com for details. Use of
 * Jigloo implies acceptance of these licensing terms. A COMMERCIAL LICENSE HAS
 * NOT BEEN PURCHASED FOR THIS MACHINE, SO
 * JIGLOO OR THIS CODE CANNOT BE USED LEGALLY FOR ANY CORPORATE OR COMMERCIAL
 * PURPOSE.
 */
public class WaarpUiPassword extends javax.swing.JFrame {
  ...
  private void initGUI() {
    try {
      ...
      thisLayout.setVerticalGroup(thisLayout.createSequentialGroup()
                                            .addContainerGap()
                                            .addComponent(jTextFieldKeyFile,
                                                          GroupLayout.PREFERRED_SIZE,
                                                          28,
                                                          GroupLayout.PREFERRED_SIZE)
                                            .addGap(21)
  ...
  private JDialog getJDialogHelp() {
    if (jDialogHelp == null) {
      ...
      GroupLayout jDialogHelpLayout =
          new GroupLayout((JComponent) jDialogHelp.getContentPane());
      jDialogHelp.getContentPane().setLayout(jDialogHelpLayout);
      jDialogHelp.getContentPane()
